...
function Preview() {
    return (
        <div className="flex flex-col gap-4 w-1/2 border rounded-sm shadow-lg justify-between">
            ...
            <div className=" bg-[#e0fec5] w-3/4 h-fit rounded-sm self-end mb-10 mr-5 p-2">something dsfdfds dsf df dsf dsf dsf dsfds fds fsadosa dassadksl sadasdsasa sdasdsa sadasdsa dsad asd asd sad sad asd as</div>
        </div>
    )
}
